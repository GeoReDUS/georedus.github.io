# Densidade Demográfica (Área Domiciliada)
...
O indicador mostra a densidade demográfica de moradores residentes em Domicílios Particulares Ocupados (DPO) por área domiciliada em cada setor censitário, a partir dos dados do Censo Demográfico de 2022 do IBGE. O valor é obtido pela razão entre o total de pessoas residentes em DPO e a área domiciliada em km² no setor censitário..

**Exemplo**:
> No município de Teresina (PI), no setor censitário 221100105000010, foram registrados 542 moradores residindo em domicílios particulares e 0,38632 quilometros quadrados de área domiciliada. Ao relacionar o total de moradores à área domiciliada, obtém-se 1402,98 moradores por quilometro quadrado.

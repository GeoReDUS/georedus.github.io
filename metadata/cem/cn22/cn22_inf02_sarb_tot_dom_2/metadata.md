...
O indicador mostra a porcentagem de domicílios particulares permanentes ocupados (DPPO) sem arborização no entorno em relação ao total de DPPO, para cada setor censitário, segundo o Censo Demográfico de 2022 do IBGE.
...
O indicador mostra a porcentagem de moradores residentes em domicílios particulares permanentes ocupados (DPPO) sem arborização no entorno em relação ao total de moradores residentes em DPPO, para cada setor censitário, segundo o Censo Demográfico de 2022 do IBGE.
...
- [cn22_inf.qmd#L218](https://github.com/GeoReDUS/cn22-inf/blob/main/r/cn22_inf.qmd#L218)
- [cn22_inf.qmd#L221](https://github.com/GeoReDUS/cn22-inf/blob/main/r/cn22_inf.qmd#L221)
